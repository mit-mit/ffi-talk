...
class LocalVeggieProvider {
  static List<Veggie> veggies = [
    Veggie(
      ...
      description: 'Green or red, they\'re generally round and tasty.',
      accentColor: 0x40de8c66,
    ...
    Veggie(
      ...
      description: 'The armadillo of vegetables.',
      accentColor: 0x408ea26d,
    ...
    Veggie(
      ...
      description: 'It\'s been used a food and medicine for millenia.',
      accentColor: 0x408cb437,
    ...
    Veggie(
      ...
      description: 'One of the oiliest, richest fruits money can buy.',
      accentColor: 0x40b0ba59,
    ...
    Veggie(
      ...
      description: 'Find them on backroads and fences in the Northwest.',
      accentColor: 0x409d5adb,
    ...
    Veggie(
      ...
      description: 'A fruit so tasty there\'s a utensil just for it.',
      accentColor: 0x40f6bd56,
      seasons: [Season.summer],
    ...
    Veggie(
      ...
      description: 'Looks like white broccoli and explodes when cut.',
      accentColor: 0x40c891a8,
    ...
    Veggie(
      id: 8,
      name: 'Endive',
      image: 'assets/images/endive.jpg',
      category: VeggieCategory.leafy,
      description: 'It\'s basically the veal of lettuce.',
      accentColor: 0x40c5be53,
    ...
    Veggie(
      ...
      category: VeggieCategory.fruit,
      description: 'Delicious when sliced and wrapped in prosciutto.',
      accentColor: 0x40aa6d7c,
    ...
    Veggie(
      ...
      category: VeggieCategory.berry,
      description: 'Couldn\'t have wine without them.',
      accentColor: 0x40ac708a,
      seasons: [Season.autumn],
      vitaminAPercentage: 0,
      vitaminCPercentage: 2,
      servingSize: '3/4 cup',
    ...
    Veggie(
      id: 11,
      name: 'Green Pepper',
      image: 'assets/images/green_bell_pepper.jpg',
      category: VeggieCategory.stealthFruit,
      description: 'Pleasantly bitter, like a sad movie.',
      accentColor: 0x408eb332,
      seasons: [Season.summer],
    ...
    Veggie(
      id: 12,
      name: 'Habanero',
      image: 'assets/images/habanero.jpg',
      category: VeggieCategory.stealthFruit,
      description: 'Delicious... in extremely small quantities.',
      accentColor: 0x40ff7a01,
      seasons: [Season.summer, Season.autumn],
    ...
    Veggie(
      ...
      category: VeggieCategory.cruciferous,
      description: 'The meanest vegetable. Does not want to be eaten.',
      accentColor: 0x40a86bd8,
    ...
    Veggie(
      ...
      category: VeggieCategory.berry,
      description: 'Also known as Chinese gooseberry.',
      accentColor: 0x40b47b37,
      seasons: [Season.summer],
      vitaminAPercentage: 2,
    ...
    Veggie(
      ...
      description: 'Similar to limes, only yellow.',
      accentColor: 0x40e2a500,
    ...
    Veggie(
      ...
      category: VeggieCategory.citrus,
      description: 'Couldn\'t have ceviche and margaritas without them.',
      accentColor: 0x4089b733,
      seasons: [Season.winter],
      vitaminAPercentage: 0,
    ...
    Veggie(
      ...
      description: 'A fun orange fruit popular with smoothie enthusiasts.',
      accentColor: 0x40fcc93c,
      seasons: [Season.summer, Season.autumn],
    ...
    Veggie(
      ...
      description: 'They\'re not truffles, but they\'re still tasty.',
      accentColor: 0x40ba754b,
      seasons: [Season.spring, Season.autumn],
      vitaminAPercentage: 0,
      vitaminCPercentage: 2,
    ...
    Veggie(
      id: 19,
      name: 'Nectarines',
      image: 'assets/images/nectarine.jpg',
      category: VeggieCategory.stoneFruit,
      description: 'Tiny, bald peaches.',
      accentColor: 0x40e45b3b,
      seasons: [Season.summer],
    ...
    Veggie(
      ...
      category: VeggieCategory.fruit,
      description: 'It\'s like a plum and an apple had a baby together.',
      accentColor: 0x40979852,
      seasons: [Season.winter, Season.autumn],
      vitaminAPercentage: 0,
    ...
    Veggie(
      ...
      category: VeggieCategory.stoneFruit,
      description: 'Popular in fruit salads and children\'s tales.',
      accentColor: 0x40e48b47,
      seasons: [Season.summer],
      vitaminAPercentage: 8,
    ...
    Veggie(
      ...
      description: 'King of starches and giver of french fries.',
      accentColor: 0x40c65c63,
      seasons: [Season.winter, Season.autumn],
      vitaminAPercentage: 0,
    ...
    Veggie(
      id: 23,
      name: 'Radicchio',
      image: 'assets/images/radicchio.jpg',
      category: VeggieCategory.leafy,
      description: 'It\'s that bitter taste in the salad you\'re eating.',
      accentColor: 0x40d75875,
      seasons: [Season.spring, Season.autumn],
      vitaminAPercentage: 0,
      vitaminCPercentage: 10,
    ...
    Veggie(
      ...
      description: 'Try roasting them in addition to slicing them up raw.',
      accentColor: 0x40819e4e,
      seasons: [Season.spring, Season.autumn],
      vitaminAPercentage: 0,
    ...
    Veggie(
      ...
      description: 'Just slather them in butter and pop \'em in the oven.',
      accentColor: 0x40dbb721,
      seasons: [Season.winter, Season.autumn],
    ...
    Veggie(
      ...
      category: VeggieCategory.berry,
      description: 'A delicious fruit that keeps its seeds on the outside.',
      accentColor: 0x40f06a44,
    ...
    Veggie(
      id: 27,
      name: 'Tangelo',
      image: 'assets/images/tangelo.jpg',
      category: VeggieCategory.citrus,
      description: 'No one\'s sure what they are or where they came from.',
      accentColor: 0x40f88c06,
      seasons: [Season.winter, Season.autumn],
      vitaminAPercentage: 6,
    ...
    Veggie(
      ...
      category: VeggieCategory.stealthFruit,
      description: 'A new world food with old world tradition.',
      accentColor: 0x40ea3628,
      seasons: [Season.summer],
    ...
    Veggie(
      ...
      category: VeggieCategory.melon,
      description: 'Everyone\'s favorite closing act at the picnic.',
      accentColor: 0x40fa8c75,
      seasons: [Season.summer],
    ...
    Veggie(
      ...
      image: 'assets/images/orange_bell_pepper.jpg',
      category: VeggieCategory.stealthFruit,
      description: 'Like green pepper, but nicer.',
      accentColor: 0x40fd8e00,
      seasons: [Season.summer],
      vitaminAPercentage: 4,
      vitaminCPercentage: 190,
      servingSize: '1 medium pepper',
